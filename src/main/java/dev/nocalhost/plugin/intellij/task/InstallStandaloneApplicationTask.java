...
public class InstallStandaloneApplicationTask extends Task.Backgroundable {
    ...
    public InstallStandaloneApplicationTask(@Nullable Project project,
    ...
    public void onThrowable(@NotNull Throwable e) {
        NocalhostNotifier.getInstance(project).notifyError(
                "Nocalhost Install Application Error",
                "Error occurred while installing application " + applicationName, e.getMessage());
    }
}
